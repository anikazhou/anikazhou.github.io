  ...
  renderFreqDomain: function() {
    ...
    if (this.stopped == false){
      ...
      if (horiz_shift_start1 > 0) {
        ...
        //   0, horiz_shift_start1-horiz_shift_start, this.height, 
        //   0, 0, horiz_shift_start1-horiz_shift_start, this.height)
        segmentCtx.drawImage(tempSegmentCtx.canvas, 0, 0, this.width / 2, this.height, 0, 0, tempSegmentCtx.width / 2, tempSegmentCtx.height);
