  ...
  renderFreqDomain: function() {
    ...
    if (this.stopped == false){
      ...
      if (horiz_shift_start1 > 0) {
        ...
        segmentCtx.drawImage(tempSegmentCtx.canvas, horiz_shift_start1, 0, horiz_shift_start-horiz_shift_start1, 
          tempSegmentCtx.canvas.height, 0, 0, (horiz_shift_start-horiz_shift_start1)/4, tempSegmentCtx.canvas.height)
